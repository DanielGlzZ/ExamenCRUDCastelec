...
const response = await userService.userByID(+route.params.id)
user.value.name = response.name
user.value.age = response.age
careerSelected.value = {value: response.career.id, label: response.career.name}    
}
getUserByID()
...
const updateUser = async() => {
    ...
    if(user.value.name != '' && user.value.age != '' && careerSelected != null){
        await userService.updateUser(+route.params.id, user.value)
